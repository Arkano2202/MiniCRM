...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 13-05-2025 a las 16:32:56
...
--
-- Estructura de tabla para la tabla `proximas_citas`
--
...
--
-- Indices de la tabla `proximas_citas`
--
ALTER TABLE `proximas_citas`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT de la tabla `proximas_citas`
--
ALTER TABLE `proximas_citas`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
...
CREATE TABLE `notas` (
  `id` int(11) NOT NULL,
  `TP` varchar(20) NOT NULL,
  `UltimaGestion` varchar(20) NOT NULL,
  `FechaUltimaGestion` varchar(20) NOT NULL,
...
--
-- Estructura de tabla para la tabla `user_filters`
--
...
--
-- Indices de la tabla `user_filters`
--
...
--
-- AUTO_INCREMENT de la tabla `user_filters`
--
ALTER TABLE `user_filters`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
...
CREATE TABLE `usuarios` (
  ...
  `tipo` enum('comprador','vendedor') DEFAULT 'comprador',
